    ...
    <nav class="p-6 bg-gray-800 flex justify-between mb-6">
        <?php $__env->startSection('sidebar'); ?>
             <ul class="flex items-start">
                <li><a href="<?php echo e(route('dashboard')); ?>" class="p-3 text-yellow-400">John</a></li>
            </ul>
            ...
            <ul class="flex items-center">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->user_type == "administrator"): ?>
                        <li><a href="<?php echo e(route('amdminreg')); ?>" class="p-3 text-white">Register User</a></li>
                    <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\digiLogWeb-main\resources\views/layouts/adminapp.blade.php ENDPATH**/ ?>